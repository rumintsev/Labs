n, m, k = int(input()), int(input(), int(input() # количество экспонатов, которые хочет украсть вор; количество заходов вора; вес, который может унести вор за один заход
weights = [int(i) for i in input().split()] # создаем список с весом экспонатов
prices = [int(i) for i in input().split()] # создаем список со стоимостью экспонатов
...
total_price = 0 # переменная, отвечающая за цену украденного
